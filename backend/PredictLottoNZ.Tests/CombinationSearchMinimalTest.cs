...
/// Minimal standalone test for combination search functionality
/// </summary>
public static class CombinationSearchMinimalTest
{
    public static async Task Main(string[] args)
    {
        Console.WriteLine("Running Minimal Combination Search Property Test...");
        Console.WriteLine("=================================================");
    ...
    private static CombinationSearchResult SimulateCombinationSearch(int[] combination, List<TestDraw> draws, bool includePartialMatches)
    {
        ...
        return new CombinationSearchResult
        {
    ...
    private static void ValidateCombinationSearchResult(CombinationSearchResult result, int[] combination, List<TestDraw> testDraws)
    {
    ...
    private class CombinationSearchResult
    {
    ...
    private class CombinationMatch
    {
        public int DrawNumber { get; set; }
